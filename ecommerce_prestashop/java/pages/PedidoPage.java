...
public class PedidoPage {
		...
		private By totalPeodutos = By.cssSelector("div.order-confirmation-table div.order-line div.row div.bold");
		...
		public Double obter_totalProdutos() {				
			return Funcoes.removeCifraoDevolveDouble(driver.findElement(totalPeodutos).getText());
		}
