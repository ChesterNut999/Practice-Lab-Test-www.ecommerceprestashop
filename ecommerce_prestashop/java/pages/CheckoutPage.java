...
public class CheckoutPage {
	...
	private By checkboxAgree = By.id("conditions_to_approve[terms-and-conditions]");
	...
	public void clicarBotaoContinueShipping() {
		driver.findElement(botaoContinueShipping).getText();
	}
	...
	public boolean estaSelecionadoCheckboxIAgree() {
		return driver.findElement(checkboxAgree).isSelected();
	}
