...
public class ComprarProdutoSteps {
	...
	public void nome_do_produto_na_tela_principal_eh_(String nomeProduto) {
	...
	// CAPUTAR EVIDENCIAS CUCUMBER E FINALIZAR TESTES
	@After(order = 1)
	public void capturarTela(Scenario scenario) {
		// var camera = (TakesScreenshot) driver; --> Usuado a partir do JSD_10
		TakesScreenshot camera = (TakesScreenshot) driver;
		File capturaDeTela = camera.getScreenshotAs(OutputType.FILE);

		// CAPTURAR ID DE CADA CENARIO / PRINT
		System.out.print(scenario.getId());
		String scenarioID = scenario.getId().substring(scenario.getId().lastIndexOf(".feature:") + 9);

		String nomeArquivo = "resources/screenshots/" + scenario.getName() + "_" + scenarioID + "_"
				+ scenario.getStatus() + ".png";
